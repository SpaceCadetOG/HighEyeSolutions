  ...
  return (
    <>
      <PageHero
        ...
        description="The company is focused on practical aerial services for property, contractor, real estate, and business clients across priority Texas, Louisiana, and Illinois markets while building toward larger commercial and industrial operations."
      />
