...
export default function HomePage() {
  return (
    <>
      ...
      <section className="border-y border-white/10 bg-white/5 px-4 py-5 sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-7xl flex-wrap gap-3">
          {trustItems.map((item) => (
            <span
              key={item}
              className="border border-white/10 bg-navy/70 px-3 py-2 text-xs font-bold uppercase tracking-[0.16em] text-slate-300"
            >
              {item}
            </span>
          ))}
